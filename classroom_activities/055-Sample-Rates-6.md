...
To start our experimentation with the Repeat block, let's use a smaller sample rate: 80 samples per second.
...
5. Try different values for Interpolation. How does that affect the frequency of the square wave? What number should you pick if you want the square wave to have a frequency of 1 Hz? How is that number related to the Sample Rate?