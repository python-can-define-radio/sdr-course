...
A normal Python list does not interpret the `+` as addition to each element of `timestamps`. However, a numpy array does, so we'll use those for the rest of this exercise.
