Now that we've seen an example of using real hardware, we're going to explore how the GNU Radio blocks work without hardware. (Don't worry, we'll get back to the hardware soon!)
